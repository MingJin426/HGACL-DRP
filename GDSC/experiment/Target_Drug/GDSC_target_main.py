...
from GDSC.experiment.Target_Drug.sampler import Sampler
from GDSC.experiment.myutils import roc_auc, translate_result, common_data_index, dir_path
...
total_trainings = total_targets * n_kfolds * k  # 总训练次数
count = 0
